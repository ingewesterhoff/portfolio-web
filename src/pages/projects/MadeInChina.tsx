...
export function MadeInChina() {
  ...
  const carouselImages = [
    "https://images.unsplash.com/photo-1578321272176-b7bbc0679853?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjaGluZXNlJTIwY2VyYW1pY3N8ZW58MXx8fHwxNzYxMjI5OTA2fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    "https://images.unsplash.com/photo-1609743522471-83c84ce23e32?w=800",
    "https://images.unsplash.com/photo-1610527003928-47aeb7955a8a?w=800",
  ];
      ...
      <div className="px-6 sm:px-8 md:px-12 lg:px-24 xl:px-32 2xl:px-[188px] pt-44 sm:pt-48 md:pt-52 lg:pt-56 pb-24 sm:pb-28 md:pb-32 relative">
        ...
        <div className="mb-12 sm:mb-14 md:mb-16 relative z-10 max-w-6xl mx-auto">
          ...
          <p className="font-['Roboto',sans-serif] text-[15px] sm:text-[16px] md:text-[17px] lg:text-[18px] text-[#ede6f7] leading-[1.8]">
            An interactive exhibit exploring the global
            influence of Chinese ceramics through visual
            comparison of 14 object pairs.
          </p>
        </div>
          ...
          <Slider {...sliderSettings}>
            {carouselImages.map((image, index) => (
              <div key={index}>
                <ImageWithFallback
                  src={image}
                  alt={`Made In China project image ${index + 1}`}
        ...
        <div className="max-w-6xl mx-auto mb-20 sm:mb-24 md:mb-28 relative z-10">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
            {[
              ...
              { label: "Tools", value: "Figma, BrightAuthor" },
              { label: "Skills", value: "UX/UI Design" },
              { label: "Team", value: "MCW Agency" },
            ].map((item, index) => (
              <motion.div
                key={index}
          ...
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col gap-10">
              ...
              <p className="font-['Roboto',sans-serif] text-[15px] sm:text-[16px] md:text-[17px] text-[#ede6f7] leading-[1.8]">
                The Made in China exhibition needed to
                communicate the vast global influence of Chinese
                ceramic art and craftsmanship. Visitors needed
                an engaging way to understand not just what
                Chinese ceramics look like, but how they
                inspired and influenced ceramic traditions
                across different cultures. The challenge was
                making these complex cultural connections clear
                and accessible without overwhelming visitors
                with text.
              </p>
              ...
              <div className="flex flex-col gap-6">
                ...
                <p className="font-['Roboto',sans-serif] text-[15px] sm:text-[16px] md:text-[17px] text-[#ede6f7] leading-[1.8]">
                  Museum visitors view ceramic objects in
                  vitrines with lengthy text panels. The
                  connections between Chinese originals and
                  their global influences are difficult to see,
                  requiring visitors to read extensively and
                  mentally compare objects that may be far apart
              ...
              <div className="flex flex-col gap-6">
                ...
                <p className="font-['Roboto',sans-serif] text-[15px] sm:text-[16px] md:text-[17px] text-[#ede6f7] leading-[1.8]">
                  Visitors use an interactive installation to
                  directly compare Chinese ceramics with their
                  cultural descendants. They can zoom into
                  details, see side-by-side comparisons, and
                  quickly understand key characteristics—what's
                  Chinese, what's unique to each culture—through
                  visual exploration rather than text.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="flex flex-col gap-10">
                <div className="flex flex-col gap-6">
                  ...
                  <div className="flex flex-col gap-5">
                    <p className="font-['Roboto',sans-serif] text-[15px] sm:text-[16px] md:text-[17px] text-[#ede6f7] leading-[1.8]">
                      As part of MCW Creative Agency, I designed
                      and developed the complete interactive
                      installation for the ceramics section. I
                      created the information architecture for
                      14 object pairs, structured the comparison
                      system highlighting 3-4 key
                      characteristics per object, and designed
                      the zoom functionality that allows
                      visitors to explore fine details. I
                      focused on visual storytelling to minimize
                      text dependency.
                    </p>
                    <p className="font-['Roboto',sans-serif] text-[15px] sm:text-[16px] md:text-[17px] text-[#ede6f7] leading-[1.8]">
                      I developed a dual-view system that
                      presents both overview and detail photos
                      simultaneously. Visitors can quickly
                      identify differences through visual
                      markers rather than reading lengthy
                      descriptions. The interface emphasizes
                      what is distinctly Chinese versus what
                      reflects each object's cultural heritage.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <div className="flex flex-col gap-5">
                    <p className="font-['Roboto',sans-serif] text-[15px] sm:text-[16px] md:text-[17px] text-[#ede6f7] leading-[1.8]">
                      The biggest challenge was deciding which
                      characteristics to highlight for each
                      object. With limited space in the
                      interactive, I had to distill complex
                      cultural histories into 3-4 clear visual
                      points that visitors could understand
                      quickly.
                    </p>
                    <p className="font-['Roboto',sans-serif] text-[15px] sm:text-[16px] md:text-[17px] text-[#ede6f7] leading-[1.8]">
                      Balancing educational depth with
                      accessibility required close collaboration
                      with curators and multiple rounds of
                      testing. Additionally, ensuring the zoom
                      functionality remained smooth while
                      displaying high-resolution ceramic details
                      demanded careful technical optimization.
                    </p>
                  </div>
                </div>
              </div>
